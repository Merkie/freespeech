                ...
                if "page" in box:
                    ...
                    if "image" in box:
                        built += (
                            ...
                            + redirectcolor
                            + '"><a onclick="eel.speak(this.innerHTML);" href="'
                            + str(count)
                            + '.html" style="color:white"><div class="inner" style="display : block; padding-top:20%"><img src="'
                            + box["image"]
                            + '" style="width: 60%; height:60%;"><p spokenvalue="'
                            + box["text"]
                            + '">'
                            + box["name"]
                            + "</p></div></a></div>"
                        ...
                        built += (
                            ...
                            + '"><a onclick="eel.speak(this.innerHTML);" href="'
                            + str(count)
                            + '.html" style="color:white"><div class="inner"><p spokenvalue="'
                            + box["text"]
                            + '">'
                            + box["name"]
                            + "</p></div></a></div>"
                    ...
                    if "home" in box:
                        built += (
                            '<div class="box" style="border-radius: 25px; background-color: '
                            + homecolor
                            + ';"><a href="index.html" style="color:white"><div class="inner"><p><i>Home</i></p></div></a></div>'
                        )
                    else:
                        if "image" in box:
                            built += (
                                '<div class="box" style="background-color: '
                                + color
                                + '"><a onclick="eel.speak(this.innerHTML);"><div class="inner" style="display : block; padding-top:20%"><img src="'
                                + box["image"]
                                + '" style="width: 60%; height:60%;"><p spokenvalue="'
                                + box["text"]
                                + '">'
                            ...
                            built += (
                                '<div class="box" style="background-color: '
                                + color
                                + '"><a onclick="eel.speak(this.innerHTML);"><div class="inner"><p spokenvalue="'
                                + box["text"]
                                + '">'
                                + box["name"]
                                + "</p></div></a></div>"
