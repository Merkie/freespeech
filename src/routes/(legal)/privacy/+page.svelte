<div class="mx-auto flex w-[90%] max-w-[1400px] flex-col gap-2 py-[100px]">
	...
	<ul>
		...
		<li>
			<p>
				...
				or &quot;Our&quot; in this Agreement) refers to Free Speech AAC.
			</p>
		</li>
		<li>
			<p>
		...
		<li>
			<p>
				<strong>Website</strong> refers to Free Speech AAC, accessible from
				<a href="https://www.freespeechaac.com" rel="external nofollow noopener" target="_blank"
					>https://www.freespeechaac.com</a
				>
			</p>
		</li>
		<li>
	...
	<ul>
		<li>By email: archercalder@gmail.com</li>
	</ul>
</div>
